...
import { AppointmentRegisteredHandler, AppointmentAssignedHandler } from '../../../../src/application/event-handlers/appointment-events.handler';
...
describe('AppointmentEventsHandlers (Split OCP Handlers)', () => {
    ...
    describe('AppointmentRegisteredHandler', () => {
        ...
        beforeEach(async () => {
            ...
            handler = module.get<AppointmentRegisteredHandler>(AppointmentRegisteredHandler);
        });
        ...
        it('should notify on AppointmentRegisteredEvent', async () => {
            ...
            expect(mockNotificationPort.notifyAppointmentUpdated).toHaveBeenCalledWith(dummyAppointment);
        });
    });
    ...
    describe('AppointmentAssignedHandler', () => {
        ...
        beforeEach(async () => {
            ...
            handler = module.get<AppointmentAssignedHandler>(AppointmentAssignedHandler);
        });
