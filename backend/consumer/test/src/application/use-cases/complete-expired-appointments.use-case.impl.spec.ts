...
describe('CompleteExpiredAppointmentsUseCaseImpl', () => {
    ...
    describe('execute', () => {
        ...
        it('should notify for each completed appointment', async () => {
            ...
            mockRepository.setFindExpiredCalledResult([expiredAppointment1, expiredAppointment2]);
    ...
    describe('edge cases', () => {
        ...
        it('should handle multiple rapid completions', async () => {
            ...
            const expired = Array.from({ length: 10 }, (_, i) =>
                new Appointment(
        ...
        it('should handle appointments with different completion times', async () => {
            ...
            const appointments = [
                new Appointment(new IdCard(111111111), new FullName('P1'), new Priority('high'), 'called', 'C1', 500000, 600000), // Old
                new Appointment(new IdCard(222222222), new FullName('P2'), new Priority('medium'), 'called', 'C2', 800000, 900000), // Recent
            ];
