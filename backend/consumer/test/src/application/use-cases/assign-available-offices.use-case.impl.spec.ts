...
describe('AssignAvailableOfficesUseCaseImpl', () => {
    ...
    describe('execute', () => {
        ...
        it('should use ConsultationPolicy for random duration', async () => {
            ...
            expect(assigned.completedAt).toBe(1000000 + (expectedDurationSeconds * 1000));
        });
        ...
        it('should limit assignments to min(freeOffices, waiting)', async () => {
            const waiting = [
                new Appointment(new IdCard(111111111), new FullName('P1'), new Priority('medium'), 'waiting', null, 1000000),
                new Appointment(new IdCard(222222222), new FullName('P2'), new Priority('medium'), 'waiting', null, 1000000),
                new Appointment(new IdCard(333333333), new FullName('P3'), new Priority('medium'), 'waiting', null, 1000000),
            ];
    ...
    describe('complex scenarios', () => {
        it('should handle mixed priority levels with correct ordering', async () => {
            const waiting = [
                new Appointment(new IdCard(111111111), new FullName('Low 1'), new Priority('low'), 'waiting', null, 1000000),
                new Appointment(new IdCard(222222222), new FullName('Medium 1'), new Priority('medium'), 'waiting', null, 1000000),
                new Appointment(new IdCard(333333333), new FullName('High 1'), new Priority('high'), 'waiting', null, 1000000),
                new Appointment(new IdCard(444444444), new FullName('High 2'), new Priority('high'), 'waiting', null, 2000000),
            ];
