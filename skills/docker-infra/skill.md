...
4. Development-only configs (volumes, `start:dev`) must have `// ⚕️ HUMAN CHECK` noting removal for production.
...
4. Apply changes and add `// ⚕️ HUMAN CHECK` for security-sensitive changes.
